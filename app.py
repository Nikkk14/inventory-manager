...
from database.init_db import init_db  # Import init_db
...
if __name__ == '__main__' or os.environ.get("RENDER") == "true":
    ...
    # Always initialize the DB (safe since it uses CREATE IF NOT EXISTS)
    init_db()

    port = int(os.environ.get("PORT", 5000))
    app.run(host='0.0.0.0', port=port, debug=os.environ.get("RENDER") != "true")
